...
> Superseded historical record: this file describes the abandoned split-Worker plan. Do not execute its instructions. Current authority and evidence are in [backend_map.md](../../backend_map.md).
